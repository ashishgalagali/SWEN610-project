...
define(function (require) {
     ...
     */
    var MultipleJumpState = function (view) {
        this._first = true;
     ...
     */
    MultipleJumpState.prototype.getName = function getName() {
        return GameConstants.MULTIPLE_JUMP_STATE;
    }

    /**
     * Method when entering this state.
     */
    MultipleJumpState.prototype.onEntry = function onEntry() {
     ...
     */
    MultipleJumpState.prototype.requestMove = function requestMove(pendingMove) {
